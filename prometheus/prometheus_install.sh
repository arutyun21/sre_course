...
cp -r /tmp/prometheus-2.37.0.linux-amd64/console_libraries /etc/prometheus # Создадим простой файл конфигурации
...
useradd --no-create-home --shell /bin/false prometheus # Сменим разрешения на директории
